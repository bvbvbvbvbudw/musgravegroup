    ...
    <article id="post-7799" class="post-7799 page type-page status-publish hentry">
        <div class="container">
            <div class="careers-text-block" data-aos="fade-up" data-aos-once="true">
                <h2>A <em>unique</em> and <em>inspiring</em> place to work</h2>
                <p><strong>Musgrave is a fast-moving business, entrepreneurial, driven by a strong ethical approach and
                        our purpose of Growing Good Business.</strong></p>
                <p>You’ll find family runs deep in Musgrave. Not just because we are a sixth-generation Irish family
                    business, but in the ways in which we nurture talent and the culture we create in our workplaces. We
                    actively encourage colleagues to support each other, and to become active in local communities –
                    championing causes and making a difference to people and the environment</p>
            </div>
            ...
            <div class="container">
                ...
                <section class="slider-text-nav" data-aos="fade-up">
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Culture</h2>
                            <p>Being a family business informs our culture and our values, which are long-term stable
                                relationships, working hard, not being greedy, honesty and achievement. These, coupled
                                with our purpose of Growing Good Business, inspire us to deliver not just a profitable
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Inclusivity</h2>
                            <p>At Musgrave we celebrate diversity and encourage inclusivity. We have developed a strong
                                Diversity and Inclusion programme to build a stronger, more diverse Musgrave that
                                delivers sustainable returns for all. We’re engaging with our colleagues to take active
                                roles in in creating a diverse and inclusive environment which reflect the communities
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Development</h2>
                            <p>At Musgrave we invest heavily in development, because we want you to be the very best you
                                can be. Over the past three years, all our colleagues have participated in a high-level
                                training and development programme called Breakthrough, which encourages a restless and
                                entrepreneurial mindset. This has had a positive impact on our people, both personally
                                and professionally. The results have driven creativity and innovation in our ways of
                                working with profitable outcomes for the business. Colleagues are encouraged to drive
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Well-being</h2>
                            <p>We have an award-winning health and wellbeing programme within Musgrave, aimed at
                                ensuring our colleagues are happy, healthy and supported in their careers. We actively
                                encourage our people to pursue their passions and make lasting friendships, whether that
                                is getting involved in a local sports team, or working with a community project —
                                whatever your interest, you can explore it while working at Musgrave. Our Be Well Work
                                Well programme includes our Employee Assistance Programme, fresh fruit at work, healthy
                                options in canteens, a cycle to work scheme, mental health support and so much more.</p>
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Work Smart</h2>
                            <p>We have redesigned our ways of working to further empower our colleagues to focus on the
                                outcomes and contribution that everyone makes in their roles.</p>
                            <p>Work Smart @ Musgrave is our hybrid work model which allows colleagues the option to
                                alternate their time between connecting and collaborating in the office and working
                                remotely. It brings an opportunity to retain the best of the remote working experience
                                whilst enabling colleagues to connect in person and work together onsite. It supports
                                the delivery of our business growth strategy by enabling colleagues to work in a more
                                productive and agile way, focused on balancing work and life while delivering the very
                                best for our customers.</p>
                            <p>Across Musgrave, our roles allow for different levels of flexibility. Our operations and
                                retail roles work from a site location and other roles adopt a hybrid approach.</p>
