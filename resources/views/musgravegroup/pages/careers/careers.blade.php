...
@section('body-classes', 'page-template page-template-page-templates page-template-page-careers-template page-template-page-templatespage-careers-template-php page page-id-68 page-parent wp-custom-logo')
@section('content')
    <section class="blog-hero lazyload" style="background-image:url('{{asset('img/careers/1.webp')}}')" data-aos="fade-in" data-aos-once="true">
        <div class="text">
            <h1>Careers</h1>
        </div>
    </section>
    ...
    <article id="post-68" class="post-68 page type-page status-publish hentry">
        <div class="container">
            <div class="careers-text-block" data-aos="fade-up" data-aos-once="true">
                <h2>Exceptional times, <em>exceptional people</em></h2>
                <p><strong>In all our 147 year history, we’ve never been more united in our purpose – to keep
                        communities supplied with the food and goods they need and to keep everyone safe.</strong></p>
                <p>Our aim is to ensure that our brands such as SuperValu, Centra, Daybreak, Mace NI and Musgrave
                    MarketPlace are able to retain strong supply chains and sustainable levels of service in the heart
                ...
                <p>If you would like to find out more about vacancies in areas such as Finance, Supply Chain and other
                    ...
                    below.</p>
                <a class="button" href="current-vacancies/index.html">Current Vacancies</a>
            </div>
            ...
            <div class="container">
                ...
                <section class="slider-text-nav" data-aos="fade-up">
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Our people</h2>
                            <p>At Musgrave our people are the beating heart of our business. They have a passion for
                                food, and a drive to be best they can be. They are delivering transformation in retail,
                                and they are making a real difference to our environment. Some of our colleagues have
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Our brands</h2>
                            <p>We feed one in three people in Ireland through our leading 15 brands, including household
                                names such as SuperValu, Centra, Daybreak, Musgrave MarketPlace and Frank and Honest.
                            ...
                            <a class="button" href="../brands/index.html">Read more</a>
                        </div>
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <h2>Our vision</h2>
                            <p>Today we are driving innovation across Musgrave, inspired by our purpose Growing
                                <em>Good</em> Business. We have a clear vision for transforming retail and wholesale by
                                making the most of every eating occasion. We are also committed to ensuring that the
                    ...
                    <div class="slide-box">
                        <div class="text">
                            <p>The fast-moving retail sector is an exciting place to be right now, leading the way in
                                technology, innovation and food trends. Musgrave operates in Ireland, Northern Ireland
                                and Spain, and exports to countries globally. We have career opportunities in a wide
                                range of sectors, from finance and IT to supply chain and trading. Our work impacts on
                                our brands, our retail stores and communities right across the island of Ireland, in
                                collaboration with over 1,200 independent retailers. Whatever your skills, or interests
                                you&#8217;ll find a career within Musgrave that you can thrive in.</p>
