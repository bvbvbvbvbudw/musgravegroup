        ...
        <div class="entry-content container" data-aos="fade-up" data-aos-once="true">
            ...
            <div id="emailalerts">
                        ...
                        <form action="emailAlerts.php?rand=0.291248001723739969" name="applyForm" id="applyForm"
                            ...
                            <input type="hidden" name="post" value="1"><input type="hidden" name="siteURL" id="siteURL"
                                ...
                                type="hidden" name="jId" value="#jId#"><input type="hidden" name="deCacher"
                                                                              value="1947810145"><input type="hidden"
				...
				*
                                  ...
                                  placeholder="" onblur="doValidation(this, this.value, '', 'Surname is required');">
                                    ...
                                    <div style="clear:both;" id="divmobileTelephone">
                                        <label style="" for="mobileTelephone">Telephone<span
				...
				*
                                  ...
                                  placeholder=""
                                  onblur="doValidation(this, this.value, 'SameAs('passwordConfirm');ValidPassword();', 'Please ensure your password is at least six characters long and contain letters and numbers and fill in both the password and password confirm fields');">
                                  ...
                                  onblur="doValidation(this, this.value, '', 'Confirm password is required');">
                                    ...
                                    <div style="clear:both;" id="divcriteria1[]">
                                        <label style="" for="criteria1[]">Preferred work sector(s) (hold control to
                                            select more than one item)</label><select name="criteria1[]"
                                                                                      id="criteria1[]"
                                                                                      class="inputCheckbox"
                                        ...
                                        <div id="criteria1[]ErrorLabel" class="errorLabelDiv"
                                             style="display:none;"></div>
                                        <div id="criteria1[]ErrorLabelInline" class="errorLabelDiv"
                                             style="display:none;"></div>
                                    </div>
                                    <div style="clear:both;" id="divcriteria2[]">
                                        <label style="" for="criteria2[]">Preferred work location(s) (hold control to
                                            select more than one item)</label><select name="criteria2[]"
                                                                                      id="criteria2[]"
                                                                                      class="inputCheckbox"
                                        ...
                                        <div id="criteria2[]ErrorLabel" class="errorLabelDiv"
                                             style="display:none;"></div>
                                        <div id="criteria2[]ErrorLabelInline" class="errorLabelDiv"
                                             style="display:none;"></div>
                                    </div>
                                    <div style="clear:both;" id="divonsite">
                                        <label style="" for="onsite">Receive email alerts<span id="mandmarker_onsite"
                                                                                               class="errorRed">
				*
			</span></label>
                                        <div style="width:auto;" class="radioDiv">
                                            <input type="radio" name="onsite" class="radio"
                                                   style="margin-left:3.5em;margin-right:0.5em;display:inline;width:20px;"
                                                   value="n" alt="Receive email alerts - No" id="onsite_No"><label
                                                for="onsite_No" class=" radioLabel"><span class="outer"><span
                                                        class="inner"></span></span><span
                                                    class="radio_display_text">No</span></label><input type="radio"
                                                                                                       name="onsite"
                                                                                                       class="radio"
                                                                                                       style="margin-left:3.5em;margin-right:0.5em;display:inline;width:20px;"
                                                                                                       value="y"
                                                                                                       alt="Receive email alerts - Yes"
                                                                                                       id="onsite_Yes"><label
                                                for="onsite_Yes" class=" radioLabel"><span class="outer"><span
                                                        class="inner"></span></span><span
                                                    class="radio_display_text">Yes</span></label>
                                        </div>
                                        <div id="onsiteErrorLabel" class="errorLabelDiv" style="display:none;"></div>
                                        <div id="onsiteErrorLabelInline" class="errorLabelDiv"
                                             style="display:none;"></div>
                                    </div>
                                </fieldset>
                            </div>
