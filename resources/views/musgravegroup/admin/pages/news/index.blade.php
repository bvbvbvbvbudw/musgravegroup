    ...
    <div class="container mx-auto px-6 py-8">
        @foreach($news as $item)
            <div class="bg-white shadow rounded-lg p-6 mb-6">
                ...
                <div class="mb-4">
                    <strong>Status:</strong> {{ $item->is_popular ? 'Popular' : 'Not Popular' }}
                </div>

                <div class="flex space-x-4">
                    <a href="{{ route('admin.news.edit', $item->id) }}" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Edit</a>
